// https://raw.githubusercontent.com/creationix/msgpack-js-browser/master/msgpack.js
/* jshint browser: true */
...
function connect() {
    ...
    var handle = function(data) {
        ...
        var baremsg = msgpack.decode(data);

        // unmarshal from wireformat
        var rpc = {
          id: baremsg[0],
          fn: baremsg[1],
          args: baremsg[2],
